<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="web_G.register" %>
...
<body>
    <div class="container">
        ...
        <form action="Register.aspx" method="post" runat="server" id="formId">
            ...
            <input type="text" name="userType" placeholder="Client/Admin" required id="userType" runat="server">
